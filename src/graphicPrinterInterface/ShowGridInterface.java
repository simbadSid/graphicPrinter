...
public class ShowGridInterface implements ActionListener
{
// ------------------------------------ Attributs ----------------------------
...
// ------------------------------------ Constructeur--------------------------
		public ShowGridInterface(Application app)
		{
			this.app = app;
		}
...
//-----------------------------------
		...
		{
			this.frame = new JFrame("Set Grid Dimension");
			...
			JLabel xLabel			= new JLabel("Dimension of the X axe grid:");
			JLabel yLabel			= new JLabel("Dimension of the Y axe grid:");
...
//-----------------------------------
		private class okButtonListener implements ActionListener
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				boolean test = app.setGrid(true, x, y);
