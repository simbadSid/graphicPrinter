...
public class AddPointFunctionInterface implements ActionListener
{
// --------------------------------
// Attributs:
//--------------------------------
	// Parametres
	private final String			title		= "Point Function Creation";
	private final int				width		= 400;
	private final int				height		= 650;
	private final Point				location	= new Point(400, 150);
...
//Constructeur:
//--------------------------------
		public AddPointFunctionInterface( Application app)
		{
			this.app = app;
		}
...
// Load from file
// --------------------------------
		private boolean loadPointFunction(Scanner sc)
		{
			double[] X, Y;
			String func;
			int nbrPoint;
			...
			this.nbrPointArea.setText(""+X.length);
		...
		private class OkBL implements ActionListener
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				try
				{
					...
					PointFunction f = new PointFunction(X, Y, func);
